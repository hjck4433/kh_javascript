// Array 객체 : 배열에서 사용할 수 있는 많은 속성과 메서드가 저으이 되어 있음
...
// pop() : 스택 자료 구조의 특성, 배열의 맨마지막 데이터를 제거 하고 결과를 반환
...
// unshift() : 맨 앞에 요소를 추가하고, 배열의 길이를 반환
fruits3.unshift('Lemon');
console.log(fruits3);

fruits3[0] = "Banana"; // 배뎔의 인덱스로 접근해 배열의 요소 값 변경
console.log(fruits3);
...
// map() 메소드 : 배열의 각 요소를 변환하고, 그 결과를 새로운 배열로 반환하는 메소드 (리액트에서 가장 많이 사용함)
